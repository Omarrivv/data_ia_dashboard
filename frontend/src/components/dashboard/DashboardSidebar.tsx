    ...
    return (
      <>
        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          <div className="flex items-center flex-shrink-0 px-5 py-5 border-b border-slate-700/60">
            <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-violet-600 rounded-lg flex items-center justify-center shadow-lg shadow-blue-900/30">
        ...
        <Link
          ...
          className="flex-shrink-0 flex items-center gap-3 border-t border-slate-700/60 p-4 hover:bg-slate-800 transition-colors rounded-b-none group"
        >
          ...
          <ChevronRightIcon className="h-4 w-4 text-slate-600 group-hover:text-slate-400 flex-shrink-0 transition-colors" />
        </Link>
      </>
    );
  }
